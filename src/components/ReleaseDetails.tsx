        ...
        <div className="p-10 md:p-12 flex flex-col md:flex-row gap-12">
          <div className="w-full md:w-96 shrink-0">
            <div className="relative group">
              ...
              <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </div>
          </div>
          ...
          <div className="flex-1 space-y-8">
              ...
              <div className="p-6 bg-white/5 rounded-3xl border border-white/5 group hover:bg-white/10 transition-all">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {(() => {
                    ...
                    <span key={s} className="px-3 py-1 bg-white/5 text-white/60 rounded-lg text-[9px] font-black uppercase tracking-widest border border-white/5">
                      {s}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex flex-col gap-6 pt-8 border-t border-white/5">
                ...
                <div className="flex flex-wrap gap-4">
                  <button 
                    ...
                    className="vibrant-gradient text-white px-8 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-brand-primary/20 flex items-center gap-3"
                  >
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button 
                      onClick={() => setShowStatusModal({ status: 'action_required', remarks: '' })}
                      className="bg-amber-500/10 text-amber-400 px-6 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest border border-amber-500/10 hover:bg-amber-500/20 transition-all flex items-center gap-2"
                    >
                      <AlertCircle className="w-4 h-4" /> Action Required
                    </button>
                    <button 
                      onClick={() => setShowStatusModal({ status: 'streamed', remarks: '' })}
                      className="bg-indigo-500/10 text-indigo-400 px-6 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest border border-indigo-500/10 hover:bg-indigo-500/20 transition-all flex items-center gap-2"
                    >
            ...
            {user.role === 'artist' && release.status !== 'approved' && (
              <div className="flex gap-4 pt-8 border-t border-white/5">
                ...
                >
                  <Edit2 className="w-4 h-4" /> Edit Release
                </button>
                <button 
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <select 
                    ...
                    className="flex-1 px-6 py-4 rounded-2xl outline-none font-black text-sm"
                  >
                  ...
                  <input 
                    ...
                    className="flex-[2] px-6 py-4 rounded-2xl outline-none font-black text-sm"
                  />
                  <button 
                    onClick={addPlatformLink}
                    className="p-4 bg-brand-primary text-white rounded-2xl hover:scale-105 transition-all"
                  >
